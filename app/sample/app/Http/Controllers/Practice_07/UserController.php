...
use App\Http\Requests\Practice_07\GetUserRequest;
use App\Http\Requests\Practice_07\UpdateUserRequest;
use App\Http\Requests\Practice_07\CreateUserRequest;
use App\Models\User;
...
class UserController extends Controller
{
    ...
    public function index(request $request)
    {
        ...
        return view('practice_07.index', ['responseData' => $responseData]);
    }
    ...
    public function create(CreateUserRequest $request)
    {
        ...
        //返却値初期設定
        $responseData = [];
        $users = User::getAll()->withPath('/Practice_07/user');
        $responseData = [
    ...
    public function get(GetUserRequest $request)
    {
        ...
        if (is_null($user) || empty($user)) {
            ...
            return view('practice_07.edit', ['responseData' => $responseData]);
        }
    ...
    {
        return view('practice_07.create');
    }
    ...
    public function update(UpdateUserRequest $request)
    {
        ...
        if (is_null($user) || empty($user)) {
            ...
            return response()->view('practice_07.edit', ['responseData' => $responseData], 400);
        }
    ...
    public function destroy(Request $request)
    {
        ...
        return Route::Get('/Practice_07/user');
        //返却値初期設定
        $responseData = [];
        $users = User::getAll();
        $responseData = [
